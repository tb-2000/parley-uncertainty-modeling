...
def get_variables(prism_model_path, decision_variables):
    ...
    The position-local exact-belief model exposes xhat/yhat explicitly again.
    belief_state is Knowledge-internal and must NOT become an
    EvoChecker decision dimension.
    """
    ...
    if estimates != ["xhat", "yhat"]:
        raise ValueError(
            "Position-local exact-belief model must declare xhat and yhat "
