...
def models(i):
    ...
    urc_synthesis_gaussian_bias.manipulate_prism_model(infile, outfile, baseline=False) # vorher baseline=True, aber das ist nicht sinnvoll, da wir die Baseline ja erst berechnen wollen.
...
def main():
    ...
    for i in maps: # lasse auf map 23 laufen
        models(i)
        #baseline(i)
