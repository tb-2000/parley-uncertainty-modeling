...
def models(i):
    ...
    urc_synthesis_hmm_exact_local.manipulate_prism_model(infile, outfile, baseline=False) # vorher baseline=True, aber das ist nicht sinnvoll, da wir die Baseline ja erst berechnen wollen.
...
def main():
    ...
    # maps()
    maps = [44, 47] # selected_maps
    for i in maps: # lasse auf map 44, 47 laufen
        models(i)
        #baseline(i)
