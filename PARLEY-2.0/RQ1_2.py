...
def models(i):
    ...
    urc_synthesis.manipulate_prism_model(infile, outfile, baseline=True) # vorher baseline=True, aber das ist nicht sinnvoll, da wir die Baseline ja erst berechnen wollen.
