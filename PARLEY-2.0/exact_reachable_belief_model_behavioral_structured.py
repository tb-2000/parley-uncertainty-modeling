"""
Exact reachable belief model + behavioral quotient + structured PRISM encoding.

The exact reachable model and behavioral partition are unchanged.  Quotient
classes are exposed as (xhat, yhat, belief_state, substate).
"""

from exact_reachable_belief_model_sourcecopy_v2 import (
    build_exact_belief_model as build_unminimized_exact_belief_model,
)
from belief_behavioral_minimization_structured import minimize_belief_model
